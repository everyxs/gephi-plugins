 ...
 * @author everyan
 */
class GeneralFilter extends DynamicOperator {

    public static final String EIGENVECTOR = "eigenVector";
    public static final String EIGENVECTOR2 = "eigenRatioOrder";
    public static final String repFactor = "repFactor";
    
    public GeneralFilter(HierarchicalGraph graph) {
        super(graph);
    }
    ...
    public void execute(AttributeModel attributeModel) throws NotConvergedException {
        ...
        AttributeColumn replicate = nodeTable.getColumn(repFactor);
        AttributeColumn eigenCol = nodeTable.getColumn(EIGENVECTOR);
        AttributeColumn eigenCol2 = nodeTable.getColumn(EIGENVECTOR2);
        if (replicate == null) {
                        replicate = nodeTable.addColumn("repFactor", "repFactor", AttributeType.DOUBLE, AttributeOrigin.DATA, new Double(1.0));
                        JOptionPane.showMessageDialog(null, "'repFactor' attribute has been added, please edit in the Data laboratory ", 
        ...
        double[][] laplacian = laplacianGeneral(adjMatrix, replicate);
